...
class Application_Form_Category extends Zend_Form
{
    ...
    public function init()
    {
         ...
         $this->addElement('text','category',array('value'=>isset($_POST['category']) ? $_POST['category'] :'','label'=>'category ','required'=>true,'filters'=>array('StringTrim'),'validators'=>array($namevalid,$length)));
